...
public class SwaggerConfig {
    ...
    public GroupedOpenApi publicApi() {
        return GroupedOpenApi.builder()
                .group("v1")
                .packagesToScan("com.txt.josejwt.controller")
                .build();
    }
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info().title("Rest Json Web Token with nimbus-jose API")
                        .description("Documentations for Rest json web token with nimbus-jose API v1.0")
                        .version("v1.0")
