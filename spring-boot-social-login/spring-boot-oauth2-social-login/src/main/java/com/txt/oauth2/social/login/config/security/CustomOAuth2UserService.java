package com.txt.oauth2.social.login.config.security;

import com.txt.oauth2.social.login.entity.authen.AuthProvider;
import com.txt.oauth2.social.login.entity.authen.User;
import com.txt.oauth2.social.login.entity.oauth2.OAuth2UserInfo;
import com.txt.oauth2.social.login.entity.oauth2.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        ...
        user.setCreatedDate(dateCurrent);
        user.setUpdatedDate(dateCurrent);
